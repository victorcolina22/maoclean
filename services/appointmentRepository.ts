...
import { Appointment, CreateAppointmentDTO, UpdateAppointmentDTO } from '@/domain/entities/appointment'
...
export const appointmentRepository: IAppointmentRepository = {
  ...
  async update(id: string, data: UpdateAppointmentDTO): Promise<Result<Appointment>> {
    try {
